...
| Ajamäärsõnad            | Ajamäärsõnad           | Ajamäärsõnad             | Ajamäärsõnad   |
|-------------------------|------------------------|--------------------------|----------------|
| üleeile (позавчера)     | nüüd (теперь)          | vahel (иногда)           | tihti (часто)  | 
| eile (вчера)            | praegu (сейчас)        | mitte kunagi (никогда)   | sageli (часто) |
| ammu (давно)            | äsja (недавно)         | iial(gi) (никогда)       | harva (редко)  |
| enne (раньше)           | tänavu (в этом году)   | pidevalt (постоянно)     | vara (рано)    |
| hiljuti (недавно)       | homme (завтра)         | kohe (сразу)             | hilja (поздно) |
| mullu (в прошлом году)  | ülehomme (послезавтра) | ükskord (однажды)        |                |
| täna (сегодня)          | mõnikord (иногда)      | kaua (долго)             |                | 
